                    ...
                    <div className="collapse navbar-collapse" id="mynavbar">
                        <ul className="navbar-nav me-auto align-items-center justify-content-between w-100">
                            ...
                            <li className="nav-item">
                                <Link className={router.pathname == "/company" ? "nav-link active" : "nav-link"} href="/company">Company </Link>
                            </li>
                            <li className="nav-item">
                                <Link className={router.pathname == "/services" || router.pathname == "/services/[slug]" ? "nav-link active" : "nav-link"} href="/services">Services & Specialties </Link>
                            </li>
                            <li className="nav-item">
