                    ...
                    <div className="container-xl">
                        <div className="row">
                            <div className="col-12 text-center">
                                <h1><em>Built </em> by you. <em>Boosted </em> by us. <img src="/images/preview-22.png" /> </h1>
                                <p className="companysubTitle" dangerouslySetInnerHTML={{ __html: details.companySettings.companyTitle }}></p>
                                <p className="banner-information" dangerouslySetInnerHTML={{ __html: details.companySettings.companySubtitle }}></p>
                        ...
                        <div className="container-xl p-0">
                            <div className="row g-36">
                                {details.companySettings.founderBlock.map((item, index) => {
                                    ...
                                    return (
                                        <div className="col-12 col-md-4 founder-col" key={`founderblock${index}`}>
                                            <div className="shapeBox">
                                                ...
                                                <div className="limboTitle">
                                                    ...
                                                    {item.blockTagline &&
                                                        <em dangerouslySetInnerHTML={{ __html: item.blockTagline }}></em>
                                                    }
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="row g-36 align-items-center">
                                <div className="col-12 col-md-7 position-relative">
                                    <div className="founderInfo">
                                        ...
                                        <p dangerouslySetInnerHTML={{ __html: details.companySettings.aboutFounder }}></p>
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="text-center mb-5">
                                        <h4>Our team </h4>
                                        <p>
                                            Our company consists of strategists, software engineers, copywriters, and web designers – but above all, we are collaborators. <em>Always accessible, always responsive, and always happy to help </em>, we build lasting relationships with our clients that keep them coming back for more.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    {first_row &&
                                        <ul className="list-inline first-team-row">
                                            {first_row.map((item, index) => {
                                                ...
                                                return (
                                                    <li className="list-inline-item" key={`firstRow${index}`}>
                                                        <div className="col-box av-1">
                                                            <img className="avatar" src={item.node.featuredImage.node.sourceUrl} />
                                                        </div>
                                                    </li>
                                                )
                                            })}
                                    ...
                                    {second_row &&
                                        <ul className="list-inline sec-team-row text-center">
                                            {second_row.map((item, index) => {
                                                return (
                                                    <li className="list-inline-item" key={`secondRow${index}`}>
                                                        <div className="col-box av-1">
                                                            <img className="avatar" src={item.node.featuredImage.node.sourceUrl} />
                                                        </div>
                                                    </li>
                                    ...
                                    {third_row &&
                                        <ul className="list-inline third-team-row">
                                            {third_row.map((item, index) => {
                                                return (
                                                    <li className="list-inline-item" key={`thirdRow${index}`}>
                                                        <div className="col-box av-1">
                                                            <img className="avatar" src={item.node.featuredImage.node.sourceUrl} />
                                                        </div>
                                                    </li>
