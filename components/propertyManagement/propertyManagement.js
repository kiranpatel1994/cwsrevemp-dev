        ...
        <main className="position-relative prpertyManagement prpertyManagement_nw zindex-2 overflow-hidden" id="main">
                    ...
                    <div className="row g-0">
                        <div className="col-12 col-md-8 ecom__info position-relative">
                            ...
                            <div className="position-relative im_moji">
                                <div dangerouslySetInnerHTML={{__html:data.bannerDescription}}></div>
                            </div>
                            }
                        </div>
                        ...
                        <div className="col-11">
                            <div className="row g-0 why__us align-items-center">
                                <div className="col-12 online_property position-relative text-center">
                                    {data.whyUsTitle &&
                                    <div dangerouslySetInnerHTML={{__html:data.whyUsTitle
                                    }}></div>
                                    }
                            ...
                            { data.whyUsContent &&
                                <div className="row g-5 align-items-end">
                                    {data.whyUsContent.map((item, index) => {
                                        return(
                                            <div className="col-12 col-md-6 col-lg-4 box__container_col" key={`whyUs${index}`}>
                                            <div className="box__bg">
                                                ...
                                                <figure className="mb-0">
                                                    ...
                                                    <figcaption className="text-center">
                                                        <h3>{item.title} </h3>
                                                        <div className="mb-4" dangerouslySetInnerHTML={{__html:item.description}}></div>
                                                        <a className="btn btn-yellow" href={item.buttonLink}>{item.buttonText}</a>
                                                    </figcaption>
                                                </figure>
                                            </div>
                                        </div>
                        ...
                        <div className="col-11 time_acquainted ps-5">
                            ...
                            <div className="row why__us">
                                ...
                                <div className="col-12 col-md-8">
                                    <img className="img-fluid" src={data.serviceDetailsImage.sourceUrl} />
                                </div>
                                }
                            </div>
                            <div className="row g-0 why__us align-items-center">
                                ...
                                <div className="col-md-5">
                                    <img className="img-fluid" src={data.socialMediaImage.sourceUrl} />
                                </div>
                                }
                                <div className="col-md-7 automate_work position-relative">
                                    <div className="d-table ms-auto me-auto">
                                        ...
                                        <div dangerouslySetInnerHTML={{__html:data.socialMediaDescription}}></div>
                                        }
                                    </div>
                                </div>
                            </div>
                            <div className="row g-0 why__us align-items-center">
                                <div className="col-12 col-md-6 automate_work position-relative">
                                    <div className="d-table ms-auto me-auto">
                                        ...
                                        <div dangerouslySetInnerHTML={{__html:data.flexiblePaymentOptionsDescription}}></div>
                                        }
                                    </div>
                                </div>
                                {data.flexiblePaymentOptionsImage.sourceUrl &&
                                <div className="col-12 col-md-6">
                                    <img className="img-fluid" src={data.flexiblePaymentOptionsImage.sourceUrl} />
                                </div>
                                }
                            </div>
                        </div>
            ...
            <div className="last-container">
                <div className="container-xl">
                    ...
                    <div className="d-table ms-auto me-auto">
                        <a className="btn btn-yellow" href={data.experienceMarketingButtonUrl}>{data.experienceMarketingButtonText} </a>
                    </div>
                    }
                </div>
            </div>
                ...
                <div className="container-xl">
                    ...
                    <div className="row desk_top mb-5">
                        ...
                        {data.propertyManagementScreens.map((item, index) => {
                            return(
                                <div className="col-12 col-md-6 col-lg-4" key={`property-${index}`}>
                                    <img className="img-fluid" src={item.screenImage.sourceUrl} />
                                </div>
                             )
                            })}
                        </div>
                    ...
                    <div className="d-table ms-auto me-auto">
                        <a className="btn btn-yellow" href={data.propertyManagementButtonLink}>{data.propertyManagementButtonText} </a>
                    </div>
                    }
                </div>
            </div>
