        ...
        <div className="container-xl project_container p-0">
          <div className="row g-0">
            <div className="col-12 col-md-10">
              ...
              <p>
                Our collaboration with YM Ventures involved the comprehensive
          ...
          <div className="container-fluid">
            ...
            <div className="row gll__inner-col g-2">
              <div className="col-12 col-md-6">
                <img
                  className="w-100 img-fluid"
                  src="../images/ventures-2.png"
                />
              </div>
              <div className="col-12 col-md-6">
                <img
                  className="w-100 img-fluid"
                  src="../images/ventures-9.png"
                />
              </div>
            </div>
            <div className="row gll__inner-col">
